...
function Userlogin() {
    ...
    return (
        <div className='max-h-screen w-full flex flex-col justify-start mt-[30%]'>
            ...
            <div className="w-full">
                <form className='w-full flex flex-col items-center' action="" onSubmit={handleSubmit}>
                    ...
                    <input type='email' placeholder='Email' className='w-3/4 mb-2 py-2 px-2 bg-[#eeeeee] rounded-md border border-gray-300' value={email} onChange={(e) => setEmail(e.target.value)} />
                    <h1 className='text-[20px] font-semibold mb-1'>Enter your password</h1>
                    <input type='password' placeholder='Password' className='w-3/4 mb-2 py-2 px-2 bg-[#eeeeee] rounded-md border border-gray-300' value={password} onChange={(e) => setPassword(e.target.value)} />
                ...
                <div className="extras w-full flex flex-col items-center">
                    ...
                    <Link to={"/captains-login"} className='text-[18px] w-3/4 text-center bg-black text-white py-2 capitalize'>Login as captain</Link>
                </div>
                <div className='flex w-full flex-col items-center absolute bottom-3'>
                    <p className='text-[18px] mt-3'>Dont had any account?</p>
                    <Link to={"/users-signup"} className='text-[14px] mt-3 font-semibold w-3/4 text-center bg-green-300 text-white py-2 capitalize'>Sign up as user</Link>
                </div>
            </div>
        </div>
    )
